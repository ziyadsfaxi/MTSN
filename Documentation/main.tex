...
\begin{center}
	...
	\footnotesize{BY}
	\vfill
	\Large{Zeiyad Fathi Sfaxsi, Mahmood Sarzil, Karishma Patel A/P Balvantray, Fariza Aqila Bt. zulkifly} % Author name - remove the \href bracket to remove the link
	\vfill
